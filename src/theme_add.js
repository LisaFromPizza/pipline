window.addEventListener('DOMContentLoaded', async () => {
    ...
    const themeTypeGet = document.getElementById('themeType');
    const themeDescGet = document.getElementById('desc');
    const themeTextGet = document.getElementById('text');
    const themeFilesSelect = document.getElementById('files');
    const diagnosisSelect = document.getElementById('diagnosis');
    const themeSearchFiles = document.getElementById('searchFiles');
    const files = params.get('files');
  
    themeFilesSelect.value = files || '';
